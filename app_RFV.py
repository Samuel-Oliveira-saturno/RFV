...
def main():
    ...
    if (data_file_1 is not None):
        ...
        def to_excel(df):
            ...
            writer = pd.ExcelWriter("df_excel.xlsx", engine='xlsxwriter')
            ...
            # Lendo o arquivo Excel e retornando como bytes
            with open("df_excel.xlsx", "rb") as file:
        ...
        csv = convert_df(df_RFV) # Usando a função convert_df para converter o DataFrame para CSV
        ...
        excel = to_excel(df_RFV) # Usando a função to_excel para converter o DataFrame para excel
